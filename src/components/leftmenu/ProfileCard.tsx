    ...
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
      <div className="h-20 relative">
        <Image
          ...
          //   src={"/noCover.png"}
          // src="https://images.pexels.com/photos/15304870/pexels-photo-15304870/free-photo-of-regal-princess-docked-in-a-harbor.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt=""
          fill
